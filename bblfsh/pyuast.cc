...
PyInit_pyuast(void)
{
  ...
  // Tree orders
  PyModule_AddObject(m, "AnyOrder", PyLong_FromLongLong(ANY_ORDER));
  PyModule_AddObject(m, "PreOrder", PyLong_FromLongLong(PRE_ORDER));
  PyModule_AddObject(m, "PostOrder", PyLong_FromLongLong(POST_ORDER));
  PyModule_AddObject(m, "LevelOrder", PyLong_FromLongLong(LEVEL_ORDER));
  PyModule_AddObject(m, "ChildrenOrder", PyLong_FromLongLong(CHILDREN_ORDER));
  PyModule_AddObject(m, "PositionOrder", PyLong_FromLongLong(POSITION_ORDER));
